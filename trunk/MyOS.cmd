...
:MENU
	...
	IF /I '%INPUT%'=='3' (
		...
		ar rvs ./DRIVER/sys.a ./OBJ/TSS.O ./OBJ/FAT12.O ./OBJ/VFS.O ./OBJ/PAGEDIR.O ./OBJ/PAGEFAULT.O
		ar rvs ./DRIVER/sys.a ./OBJ/PAGETABLE.O ./OBJ/PHYSICAL.O ./OBJ/THREADMAN.O ./OBJ/VIRTUAL.O
	)
	IF /I '%INPUT%'=='4' (
		@ECHO START.ASM
