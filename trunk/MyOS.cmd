...
:MENU
	...
	IF /I '%INPUT%'=='3' (
		...
		@ECHO API.C
		gcc %GCC_OPTIONS% ./OBJ/API.O ./DRIVERSRC/SYSTEM/API/API.c
		@ECHO GDT.C
		...
		@ECHO THREADMAN.C
		gcc %GCC_OPTIONS% ./OBJ/THREADMAN.O ./DRIVERSRC/SYSTEM/API/THREADMAN.c
		@ECHO VIRTUAL.C
		gcc %GCC_OPTIONS% ./OBJ/VIRTUAL.O ./DRIVERSRC/SYSTEM/MEM/VIRTUAL.c
		@ECHO sys.a
		ar rvs ./DRIVER/sys.a ./OBJ/API.O ./OBJ/8259.O ./OBJ/GDT.O ./OBJ/INT.O ./OBJ/IDT.O ./OBJ/IRQ.O ./OBJ/ISR.O
		ar rvs ./DRIVER/sys.a ./OBJ/TSS.O ./OBJ/FAT12.O ./OBJ/VFS.O ./OBJ/PAGEFAULT.O ./OBJ/PHYSICAL.O
		ar rvs ./DRIVER/sys.a ./OBJ/THREADMAN.O ./OBJ/VIRTUAL.O
	)
	IF /I '%INPUT%'=='4' (
		@ECHO START.ASM
	...
	IF /I '%INPUT%'=='*' (
		...
		gcc %GCC_OPTIONS% ./OBJ/PHYSICAL.O ./DRIVERSRC/SYSTEM/MEM/PHYSICAL.c
		@ECHO DISASM.C
		gcc %GCC_OPTIONS% ./OBJ/DISASM.O ./DRIVERSRC/SYSTEM/CPU/DISASM.c
		@ECHO sys.a
		ar rvs ./DRIVER/sys.a ./OBJ/THREADMAN.O ./OBJ/VIRTUAL.O ./OBJ/PAGEFAULT.O ./OBJ/PHYSICAL.O ./OBJ/DISASM.O
		@ECHO RS232.C
		gcc %GCC_OPTIONS% ./OBJ/RS232.O ./DRIVERSRC/HARDWARE/RS232.c
		@ECHO hw.a
		ar rvs ./DRIVER/hw.a ./OBJ/RS232.O
		@ECHO START.ASM
		nasm -f aout ./KERNELSRC/START.ASM -o ./OBJ/START.O
		@ECHO MAIN.C
		gcc %GCC_OPTIONS% ./OBJ/MAIN.O ./KERNELSRC/MAIN.c
